...
DEFAULT_CONFIG = "configs/sam2.1_training/sam2.1_hiera_t_hubmap_glomerulus.yaml"
...
def parse_args():
    ...
    parser.add_argument("--dataset-root", type=str, default="", help="Prepared dataset root created by prepare_hubmap_sam2_dataset.py.")
    parser.add_argument("--init-checkpoint", type=str, default="", help="SAM2 initialization checkpoint, for example sam2.1_hiera_tiny.pt.")
